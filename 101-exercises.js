...
function isPositiveOdd(input) {
    if (isPositive(input) && isOdd(input)) {
        return true;
    }
    else {
        return false;
...
function isPositiveEven(input) {
    if (isPositive(input) && isEven(input)) {
        return true;
    }
    else {
        return false;
...
function isNegativeOdd(input) {
    if (isNegative(input) && isOdd(input)) {
        return true;
    }
    else {
        return false;
...
function isNegativeEven(input) {
    if (isNegative(input) && isEven(input)) {
        return true;
    }
    else {
        return false;
...
function endsWithVowel(x){
    var vowels = "aeiouAEIOU"
    if (vowels.indexOf(x[x.length-1]) !== -1){
        return true
    }
    else {return false}
}
...
function startsAndEndsWithVowel (x){
    var vowels = "aeiouAEIOU"
    if (vowels.indexOf(x[0])!== -1 && vowels.indexOf(x[x.length])){
        return true
    }
    else {return false}
}
...
function first(input) { //check for string vs array
...
function median (x) {
    x.sort();
    var med = Math.floor(x.length/2);
    if (isEven(x.length)) {
        return (x[med] + x[med-1]) / 2;
    } else {
        return x[med];
    }
}
...
function longestString(arr) {
    return arr.reduce((a, b) => b.length <= a.length ? a : b);
}
